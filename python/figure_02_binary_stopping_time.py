...
def plot_binary_stopping_time(use_participation, output_name):
    ...
    fig.savefig(f"figures/{output_name}.png", dpi=300, bbox_inches="tight")
...
plot_binary_stopping_time(
    ...
    output_name="binary_submitted_report_stopping_time"
)

plot_binary_stopping_time(
    use_participation=True,
    output_name="binary_calendar_stopping_time"
)